...
class TradingPredictor:
    ...
    def predict(
        ...
        --------------------------
        1. ML confidence must be ≥ ``confidence_threshold`` (default 70 %).
        2. At least ``min_indicator_alignment`` indicator signals (out of 5)
           must agree with the ML direction.
        If either condition fails → ``NO_SIGNAL``.
        """
