...
class SignalGenerator:
    ...
    @staticmethod
    def _sma_signal(close: Optional[float], sma_20: Optional[float],
                    sma_50: Optional[float]) -> int:
    ...
    def generate_signals(self, indicators: dict) -> dict:
        ...
        sigs = {
            ...
            "bb_signal": self._bb_signal(close, indicators.get("bb_upper"),
                                         indicators.get("bb_lower")),
            "sma_signal": self._sma_signal(close, indicators.get("sma_20"),
                                           indicators.get("sma_50")),
            "stoch_signal": self._stoch_signal(indicators.get("stoch_k"),
