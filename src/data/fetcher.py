...
class DataFetcher:
    ...
    def fetch_stock_data(
        ...
        period:   yfinance period string (e.g. ``"1y"``).  Ignored when *start*
                  is supplied.
        interval: yfinance interval string (e.g. ``"1d"``).
        start:    ISO date string for the start of the date range.
        end:      ISO date string for the end of the date range.
        """
    ...
    def fetch_crypto_data(
        ...
        since:     Millisecond timestamp of the first candle.
        """
        symbol = validate_symbol(symbol)
